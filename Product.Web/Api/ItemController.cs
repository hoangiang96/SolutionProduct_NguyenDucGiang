...
namespace Product.Web.Api
{
    ...
    public class ItemController : ApiControllerBase
    {
        ...
        {
            this._productService = itemService;
        }
        ...
        public HttpResponseMessage GetById(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                var responseData = Mapper.Map<Item, itemViewModel>(model);
        ...
        [Route("update")]
        [HttpPut]
        public HttpResponseMessage Update(HttpRequestMessage request, itemViewModel productVm)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<Item, itemViewModel>(dbProduct);
                    response = request.CreateResponse(HttpStatusCode.Created, responseData);
                }
        ...
        public HttpResponseMessage Delete(HttpRequestMessage request, int id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    var responseData = Mapper.Map<Item, itemViewModel>(oldProductCategory);
                    response = request.CreateResponse(HttpStatusCode.Created, responseData);
                }
